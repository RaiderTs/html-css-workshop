<h1 align="center">
    <a href="https://lectrum.io" target="_blank" rel="noopener noreferrer">
        <img src="./png/logo-woodsmoke.svg" alt="Lectrum favicon" width="25" />
    </a>
    Воркшоп по HTML & CSS
</h1>
<br>
...
<p>
    📸 Вместе мы cверстаем полноценное веб-приложение! Пристегни ремни — будет интересно!
</p>
<br>
<p>
...
```bash
git clone https://github.com/Lectrum/html-css-workshop.git
```
...
10. Перейди в браузер и открой страницу по адресу [http://localhost:8080](http://localhost:8080/).
